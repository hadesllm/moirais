...
The framework integrates work by three contributors, introduced
in turn below.

Glenn McNamara
(retired Statistics Canada and Ontario Provincial Police HQ
statistician, $\sim 30$ years' experience in correctional and
criminal-justice data design) supplied the federal correctional
data layout and the multi-source identification primitives that
make the framework portable across the five Canadian data
sources catalogued below.  Angela Zorro Medina (Department of
Sociology, University of Toronto; criminological methodology, JMP
tradition) supplied the causal-identification scaffolding
linking the provincial and federal levels.  Vansh Singh Ruhela
(University of Toronto, corresponding author) supplied the
implementation, the Hawkes/Goffmanian extensions, and the
