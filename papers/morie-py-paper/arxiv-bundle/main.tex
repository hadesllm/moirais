...
records that the MRM framework integrates.  Version~0.3.0 ships
...
\code{gibbons\_remaining} & 20 & \citet{GibbonsChakraborti2014} & \code{morie.fn.tolim.tolerance\_limits()} \\
