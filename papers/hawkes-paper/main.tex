...
IPA: \textipa{/\textscriptv @S sIN \textfishhookr U"He:lA:/}
}
...
A Hawkes process \cite{hawkes1971point} is a counting process
...
\cite{mohler2011self,short2010pde}.  I follow the spatial-physics-of
...
$[0,\infty)$, stationarity requires $\eta < 1$ \cite{daley2003intro}.
By the memorylessness of the exponential the bivariate
$(N_t,\lambda_t)$ is Markov \cite{oakes1975markovian}, which is the
...
\cite{engle1998autoregressive,kwan2023asymptotic}; epidemic
incidence has a latent period that the exponential kernel cannot
represent \cite{lauer2020incubation,escobar2020hawkes}; limit-order
books exhibit power-law decay rather than exponential
\cite{bacry2015hawkes,gould2013limit}.  In urban crime data I
...
The Kwan-Chen-Dunsmuir framework, built on \cite{kwan2024ergodic}
...
Following \cite{kwan2024ergodic,kwan2025nonstationary} I adopt an
...
$\Theta \subset \Rset^d$.
  ...
  Sornette 2015 \cite{filimonov2015apparent} small-sample
...
\cite[\S2]{kwan2025nonstationary}.

\begin{definition}[$C$-ergodicity, after Clinet \& Yoshida 2017 \cite{clinet2017statistical}]
...
\begin{theorem}[Asymptotic ergodicity; \cite{kwan2025nonstationary}, Thm.~1]
...
\begin{theorem}[Consistency of MLE; \cite{kwan2025nonstationary}, Thm.~2]
...
\begin{theorem}[Asymptotic normality of MLE; \cite{kwan2025nonstationary}, Thm.~3]
...
\cite{daley2003intro,ogata1988statistical,brown2002time} states that if $\Lambda(t) =
...
\cite{mohler2011self}; what has not been done, until now, is to
